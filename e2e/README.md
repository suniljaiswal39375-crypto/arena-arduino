...
Thirteen tests passed in this sandbox using a temporary packaged Chromium 143 binary after the normal download failed. `PLAYWRIGHT_CHROMIUM_EXECUTABLE` optionally selects such a binary; it is not a production dependency.
